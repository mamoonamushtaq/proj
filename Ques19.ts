const guests2 : string[] = ['Baby Mahnoor', 'Aapi Areeba', 'Aneela'];

console.log(`Hi ${guests2[0]}. 
...
console.log(`Assalam o alaikum ${guests2[1]}!
...
console.log(`Good morning ${guests2[2]}, 
...
console.log(`-------------------------------------------------------
`);
console.log(`We are inviting ${guests2.length} guests to birthday party.`);
console.log(`-------------------------------------------------------
`);
